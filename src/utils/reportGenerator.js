 ...
 * @param {Object} analysisData - The skin analysis data
 * @param {HTMLElement} heatmapElement - The DOM element containing the heatmap
 * @param {string} userName - The user's name
 */
export async function generateReport(analysisData, heatmapElement, userName = "User") {
  try {
    ...
    if (heatmapElement) {
      ...
      analysisData.concerns.forEach((concern) => {
        ...
        pdf.setFontSize(12)
        pdf.setTextColor(100, 100, 100)
        pdf.text(concern.description, 120, yPosition)
